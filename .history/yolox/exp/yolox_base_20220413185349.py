...
class Exp(BaseExp):
    ...
    def get_model(self):
        ...
        from yolox.models.yolo_pafpn_nofpn7 import YOLOPAFPN_NOFPN7
        ...
        if getattr(self, "model", None) is None:
            ...
            backbone = YOLOPAFPN_NOFPN7(self.depth, self.width, in_channels=in_channels, act=self.act)
    ...
    def get_data_loader(
        ...
        dataset = MosaicDetection(
            ...
            img_size=self.input_size,
            preproc=TrainTransform(
                max_labels=120,  # 在这里设置一张图中最多检测多少个目标，原值120
                flip_prob=self.flip_prob,
                hsv_prob=self.hsv_prob),
