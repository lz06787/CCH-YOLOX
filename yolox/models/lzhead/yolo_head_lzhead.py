...
from .lzhead import LZHead
from .cbam import EffectiveSELayer

class YOLOXHead_LZHEAD(nn.Module):
    def __init__(
        self,
        num_classes,
        width=1.0,
        ...
        self.lzhead = LZHead(in_channels=int(256 * width))
    ...
    def forward(self, xin, labels=None, imgs=None):
        ...
        xin = [lzhead_out["x2"], lzhead_out["x1"], lzhead_out["x0"]]
        ...
        for k, (cls_conv, reg_conv, stride_this_level, x) in enumerate(
            ...
            cls_feat = self.cls_se[k](cls_feat)+cls_feat
