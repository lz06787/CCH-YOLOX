...
class YOLOXHead_LZHEAD3(nn.Module):
    ...
    def forward(self, xin, labels=None, imgs=None):
        ...
        for k, (cls_conv, reg_conv, stride_this_level, x) in enumerate(
            ...
            cls_feat = torch.cat((cls_feat0,cls_feat1,cls_feat2), 1)
            cls_feat = self.cls_se[k](cls_feat)
            # 通道数为4 (bs,4,w,h)
            ...
            reg_feat = torch.cat((reg_feat0, reg_feat1, reg_feat2), 1)
            reg_feat = self.reg_se[k](reg_feat)
