...
class LZHead2(nn.Module):
    def __init__(self, in_channels):
        super(LZHead2, self).__init__()
    ...
    def forward(self, x):
        ...
        for i in range(3):
            ...
            if i == 0:
                ...
                x2 = torch.cat((x2, dyhead['x2']), dim=1)
                x1 = torch.cat((x1, dyhead['x1']), dim=1)
                x0 = torch.cat((x0, dyhead['x0']), dim=1)
