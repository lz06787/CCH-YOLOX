...
#from yolox.models.DynamicHead.dyhead_NoDCN import DyHead
from yolox.models.DynamicHead.dyhead_only_attention import DyHead
#from yolox.models.DynamicHead.dyhead_noscal import DyHead
class YOLOXHead_Dy(nn.Module):
    def __init__(
        self,
        num_classes,
        width=1.0,
        ...
        self.dyhead = DyHead(in_channels=int(256 * width))
