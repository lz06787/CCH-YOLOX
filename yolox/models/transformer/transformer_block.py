...
class C3STR(CSPLayer):
    ...
    def __init__(    
        ...
        super().__init__(in_channels, out_channels, n=1, shortcut=True, expansion=0.5)
        out_channels = int(out_channels * expansion)
        self.m = SwinTransformerBlock(out_channels,out_channels, out_channels//32, n)
...
class C3TR(CSPLayer):
    ...
    def __init__(        
        ...
        super().__init__(in_channels, out_channels, n=1, shortcut=True, expansion=0.5)
        out_channels = int(out_channels * expansion)
        self.m = TransformerBlock(out_channels,out_channels, 4, n)