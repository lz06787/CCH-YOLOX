...
class YOLOPAFPN(nn.Module):
    ...
    def forward(self, input):
        ...
        outputs0 = self.asff_level0(pan_out0,pan_out1,pan_out2)
        outputs1 = self.asff_level1(pan_out0,pan_out1,pan_out2)
        outputs2 = self.asff_level2(pan_out0,pan_out1,pan_out2)
        outputs = (outputs2, outputs1, outputs0)
        return outputs
