...
class YOLOPAFPN_NOFPN2(nn.Module):
    """
    ...
    def __init__(
        ...
        self.sub_pixel1 = nn.Sequential(
            nn.Conv2d(in_channels[0], in_channels[0] * (upscale_factor1 ** 2), 1),
            nn.PixelShuffle(upscale_factor1))
    ...
    def forward(self, input):
        ...
        fpn_x0_x2 = self.reduce_conv1(x0)  # 1024->256/16
        f_out1 = self.sub_pixel1(fpn_x0_x2)  # 256/8
        fpn_x1_x2 = self.reduce_conv2(x1)
        f_out2 = self.sub_pixel2(fpn_x1_x2)
        
        f_out1 = torch.cat([f_out1, f_out2, x2], 1)  # 256->512/8
