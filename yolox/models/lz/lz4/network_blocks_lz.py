...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        hidden_channels2 = int(out_channels // 1)
        Conv =  BaseConv
        ...
        self.conv2 = Conv(in_channels, hidden_channels2, 3, stride=1, act=act)

        self.conv1 = BaseConv(hidden_channels2, out_channels, 1, stride=1, act=act)
