...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        self.conv2 = Conv(hidden_channels, hidden_channels2, 3, stride=1, act=act)
        self.use_add = shortcut and in_channels == out_channels

        self.dconv = nn.Conv2d(hidden_channels2, hidden_channels2, kernel_size=3, stride=1, groups=hidden_channels2, bias=False, padding=1)
        self.bn1 = nn.BatchNorm2d(hidden_channels2)
        self.act = get_activation(act, inplace=True)
