...
class YOLONOFPN21(nn.Module):
    ...
    def __init__(
        ...
        self.buconv22 = BaseConv(int(in_channels[1]* width), int(in_channels[2]* width), 3, stride=2, act=act)
    def forward(self, input):
        ...
        f_out3 = self.buconv2(x2)
        f_out3 = self.buconv22(f_out3)
