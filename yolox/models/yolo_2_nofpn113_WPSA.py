...
class YOLO2NOFPN113WPSA(nn.Module):
    """
    ...
    def __init__(
        ...
        self.wbsa0 = WPSABlock(int(in_channels[3] * width), window_num=1)
        self.wbsa1 = WPSABlock(int(in_channels[2] * width), window_num=2)
        self.wbsa2 = WPSABlock(int(in_channels[1] * width), window_num=4)
        self.wbsa3 = WPSABlock(int(in_channels[0] * width), window_num=8)
