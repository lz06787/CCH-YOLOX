...
class EffectiveSELayer(nn.Module):
    def __init__(self, in_channel, side_num=2):
        super(EffectiveSELayer, self).__init__()
        channels = in_channel * side_num * side_num
...
class WPSABlock3(nn.Module):

    def __init__(self, in_channel=512,reduction=16,kernel_size=7,side_num=2):
        super().__init__()
        self.ca=EffectiveSELayer(in_channel, side_num=side_num)
