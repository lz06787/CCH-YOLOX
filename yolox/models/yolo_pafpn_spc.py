...
class YOLOPAFPN_SPC(nn.Module):
    ...
    def __init__(
        ...
        self.sub_pixel1 = nn.Sequential(
            nn.Conv2d(in_channels[0], in_channels[0] * (upscale_factor ** 2), 1),
            nn.PixelShuffle(upscale_factor),)
    ...
    def forward(self, input):
        ...
        f_out0 = self.sub_pixel0(fpn_out0)  # 256/13->256/26
        ...
        f_out1 = self.sub_pixel1(fpn_out1)  # 128/26->128/52
