...
from .mmdt_models.necks.augfpn import HighFPN

class YOLOPAFPN_AUGFPN(nn.Module):
    """
    ...
    def __init__(
        ...
        super().__init__()
        self.augfpn = HighFPN(in_channels=[128,256,512],out_channels=128,num_outs=3)
