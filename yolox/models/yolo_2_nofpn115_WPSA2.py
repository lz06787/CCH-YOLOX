...
from .WPSA import WPSABlock

class YOLO2NOFPN115WPSA2(nn.Module):
    """
    ...
    def __init__(
        ...
        self.wbsa0 = WPSABlock(2*int(in_channels[3] * width), side_num=1)
        self.wbsa1 = WPSABlock(3*int(in_channels[2] * width), side_num=2)
        self.wbsa2 = WPSABlock(3*int(in_channels[1] * width), side_num=4)
        self.wbsa3 = WPSABlock(2*int(in_channels[0] * width), side_num=4)    
