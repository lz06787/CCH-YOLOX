...
from .darknet2 import CSPDarknet2
from ..network_blocks import BaseConv, CSPLayer, DWConv
from ..PSA2 import ChannelAttentionPSA2

class YOLOPAFPN2PSA2(nn.Module):
    """
    ...
    def __init__(
        ...
        self.psa0 = ChannelAttentionPSA2(int(in_channels[3] * width), window_num=1)
        self.psa1 = ChannelAttentionPSA2(int(in_channels[2] * width), window_num=2)
        self.psa2 = ChannelAttentionPSA2(int(in_channels[1] * width), window_num=4)
        self.psa3 = ChannelAttentionPSA2(int(in_channels[0] * width), window_num=8)
