...
class WindowAttention_acmix(nn.Module):
    ...
    def __init__(self, dim, window_size=to_2tuple(7), num_heads=2, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        self.dep_conv = nn.Conv2d(9*dim//self.num_heads, dim, kernel_size=3, bias=True, groups=dim//self.num_heads, padding=1)
