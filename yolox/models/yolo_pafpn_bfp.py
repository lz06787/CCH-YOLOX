...
class YOLOPAFPN_BFP(nn.Module):
    ...
    def __init__(
        ...
        self.BFP = BFP(in_channels=128,num_levels=3)
        self.add_conv2 = BaseConv(int(in_channels[0]*width),int(in_channels[1] * width),1,1,act=act)
