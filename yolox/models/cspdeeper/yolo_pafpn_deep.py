...
class YOLOPAFPN_DEEP(nn.Module):
    """
    ...
    def __init__(
        ...
        self.deep_conv1 = BaseConv(int(in_channels[2] * width), int(in_channels[3] * width), 3, 2, act=act)
        #self.deep_conv2 = BaseConv(int(in_channels[3] * width), int(in_channels[3] * width), 3, 2, act=act)
    def forward(self, input):
        ...
        pan_outd1 = self.deep_conv1(pan_out0)

        outputs = (pan_out2, pan_out1, pan_out0, pan_outd1)
        return outputs
