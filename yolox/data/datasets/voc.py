...
class VOCDetection(Dataset):
    ...
    def load_image(self, index):
        ...
        if img is None:
            _imgpath_ecnu = self._imgpath.strip(".jpg")+".png"
            img = cv2.imread(_imgpath_ecnu % img_id, cv2.IMREAD_COLOR)
    ...
    def _do_python_eval(self, output_dir="output", iou=0.5):
        ...
        #annopath = os.path.join(rootpath, "Annotations", "{:s}.xml")
        annopath = 'datasets/VOCdevkit/VOC2007/Annotations/'+'{:s}.xml'
        ...
        for i, cls in enumerate(VOC_CLASSES):
            ...
            if iou == 0.5:
                print(' {}TP+FN{:d}, TP{:d}, FN{:d}, recall{:.4f}, FP{:d}, precision{:.4f}, precision2{:.4f}'.format(cls, objectnum, tpnum, objectnum-tpnum, tpnum/float(objectnum), fpnum, 1-alarm, tpnum/(tpnum+fpnum)))
