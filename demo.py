...
def make_parser():
    ...
    parser.add_argument("-expn", "--experiment-name", type=str, default='baseline_test')
    parser.add_argument("-n", "--name", type=str, default='yolox_s', help="model name")

    parser.add_argument(
        "--path", default="datasets/val/JPEGImages", help="path to images or video"
    )
...
class Predictor(object):
    ...
    def visual(self, output, img_info, cls_conf=0.35):
        ...
        rec_info = recs[img_name.strip('.jpg')]
        
        gt_box = []
        for i in rec_info:
            gt_box.append(i['bbox'])
        gt_bboxes= torch.tensor(gt_box)
...
if __name__ == "__main__":
    recs = voc_eval(                
                annopath = 'datasets/val/Annotations/{}.xml',
                imagesetfile= "datasets/val/test.txt",
                classname = ['car','van','truck','bus'],
                cachedir = 'datasets/val/annotations_cache/VOC2007/test',
                ovthresh=0.5,
                use_07_metric=True,)
